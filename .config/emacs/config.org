...
*** Code
    #+BEGIN_SRC emacs-lisp
      (use-package rainbow-delimiters
        :ensure (:fetcher github :repo "Fanael/rainbow-delimiters")
...
#+begin_src emacs-lisp
  (use-package gif-screencast
    :ensure (:fetcher  gitlab :repo "ambrevar/emacs-gif-screencast")
...
#+begin_src emacs-lisp
  (use-package request
    :ensure (:fetcher github :repo "tkf/emacs-request")
    :defer 3)
#+end_src
...
*** Code
    #+BEGIN_SRC emacs-lisp
      (use-package corfu
       :ensure (:fetcher github :repo "minad/corfu" :files (:defaults "extensions/*")
...
*** Code
    #+BEGIN_SRC emacs-lisp
      (use-package eglot-java
        :ensure (:fetcher github :repo "yveszoundi/eglot-java")
        :custom
...
*** Code
    #+begin_src emacs-lisp
      (use-package typescript-mode
        :ensure (:fetcher github :redpo "emacs-typescript/typescript.el")
...
*** Code
    #+begin_src emacs-lisp
      (use-package groovy-mode
        :ensure (:fetcher github :repo "Groovy-Emacs-Modes/groovy-emacs-modes")
        :mode ("\\.groovy\\'" "\\.gradle\\'"))
    #+end_src
...
*** code
    #+begin_src emacs-lisp
      (use-package fasm-mode
        :ensure (:fetcher github :repo "GabrielFrigo4/fasm-mode")
        :mode "\\.fasm\\'")
    #+end_src
** Initialize =zig-mode=
*** Code
    #+begin_src emacs-lisp
      (use-package zig-ts-mode
        :ensure (:fetcher codeberg :repo "meow_king/zig-ts-mode")
        :mode "\\.zig\\'")
    #+end_src
** Initialize =ocaml=
   #+begin_src emacs-lisp
     (use-package ocaml-ts-mode
       :ensure (:fetcher github :repo "terrateamio/ocaml-ts-mode")
       :mode ("\\.ml\\'" "\\.mli\\'"))
   #+end_src
