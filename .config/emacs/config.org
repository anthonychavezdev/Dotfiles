...
#+BEGIN_SRC emacs-lisp
  (use-package elfeed
    ...
    (setq elfeed-db-directory (expand-file-name "elfeed" user-emacs-directory)
          ...
          elfeed-feeds '("https://protesilaos.com/advice.xml"
...
#+BEGIN_SRC emacs-lisp
      (use-package lsp-mode
        ...
        (defun start-lsp-for-svelte ()
          (when (string= (file-name-extension buffer-file-name) "svelte")
            (lsp)))
        (add-hook 'find-file-hook 'start-lsp-for-svelte))
